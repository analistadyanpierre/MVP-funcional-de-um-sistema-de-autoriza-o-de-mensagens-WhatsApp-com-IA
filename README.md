...
2. No SQL Editor, execucao o arquivo `supabase/migrations/001_initial_schema.sql`
3. URL e chaves para `.env.local`
...
[Vercel](https://vercel.com) com variáveis de ambiente configuradas.
